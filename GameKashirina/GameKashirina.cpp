...
// GameKashirina.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGameKashirinaApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CGameKashirinaApp::OnAppAbout)
...
// Создание CGameKashirinaApp

CGameKashirinaApp::CGameKashirinaApp() noexcept
{
	...
	SetAppID(_T("GameKashirina.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CGameKashirinaApp

CGameKashirinaApp theApp;


// Инициализация CGameKashirinaApp

BOOL CGameKashirinaApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CGameKashirinaDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CGameKashirinaView));
	if (!pDocTemplate)
		return FALSE;
...
int CGameKashirinaApp::ExitInstance()
{
...
// Обработчики сообщений CGameKashirinaApp
...
void CGameKashirinaApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
